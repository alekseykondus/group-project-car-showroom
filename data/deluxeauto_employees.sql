...
INSERT INTO `employees` VALUES (1,1,'Мельник Іван Маркович','director','+380663525333'),(2,1,'Ткаченко Марк Владиславович','salesman','+380673482333'),(3,1,'Коваленко Микола Іванович','salesman','+380673481233');
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `employees_AFTER_INSERT` AFTER INSERT ON `employees` FOR EACH ROW BEGIN
	INSERT INTO employeestatistics (employeeId) VALUES (NEW.employeeId);
END */;;
DELIMITER ;
